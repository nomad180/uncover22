            ...
            <div class="flex flex-col md:ml-10 md:w-1/6">
                <div>
                    ...
                    <button class="flex justify-center w-full text-base">
                        <a href="/program" alt="Multiple people in a pushup position on a gym floor with the text Uncover Your Fit" class="inline-flex items-center py-2 px-8 pb-3 bg-secondary rounded-full text-white hover:bg-primary">Learn More</a>
                    </button>
                </div>
                 <div>
