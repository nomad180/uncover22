 @props(['post'])
  <article
        {{ $attributes->merge(['class' => 'transition duration-1000 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 rounded-lg pb-8 mb-10 p-4 mx-1']) }}>
        <div class="py-2 px-1 flex flex-col">
            ...
            <div class="mt-8 flex flex-col flex-1">
                ...
                <footer class="flex justify-between md:flex-col xl:flex-row justify-between mt-8">
                    ...
                    <div class="mt-0 sm:mt-6 md:mt:6 xl:mt-0">
                        <a href="/posts/{{ $post->slug }}"
