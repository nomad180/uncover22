...
<x-layout>
    <div class="relative">
        ...
        <div class="absolute inset-y-0 inset-x-4 md:inset-x-16 lg:inset-x-24 xl:inset-x-32 w-6/12 md:w-5/12 flex justify-center flex-col">
            ...
            <h2 class="font-bold text-xs md:text-sm lg:text-base xl:text-xl mt-4">Shed unwanted pounds, stress less, and revitalize your energy through our premier 1-on-1 health coaching programs</h2>
        </div>
    </div>
