...
<x-layout>
    ...
    <div class="mt-4 px-4 mb-4 md:px-8 lg:px-16 xl:px-32 pages">
        <div class="flex flex-col md:flex-row pages">
            <div class="md:w-3/4">
            ...
            <div class="md:w-1/4 md:mt-6 md:px-6">
                <img class="rounded-xl" src="/images/fat.jpg" alt="The belly of a fat man in business attire"  >
            </div>
        </div>
        ...
        <div class="mt-4 flex flex-col flex-col-reverse md:flex-row pages">
            <div class="md:mt-6 mx-auto">
                <img class="rounded-xl" src="/images/wish.jpg" alt="A country scene with a tree, dirt road and text Stop Wishing Start Doing">
            </div>
