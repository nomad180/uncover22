    ...
    <div class="flex flex-col lg:flex-row px-4 lg:px-16 xl:px-32 mt-16">
                ...
                <div id="result-container">
                    ...
                    <div class="mb-8 mt-16">
                        <div class="p-6 pages">
                            ...
                            <p class="mt-4 text-xl xl:text-3xl mt-4 text-center">Subcribe below to get the latest health and fitness tips from Uncover Your Fit.</p>
            ...
            <div class="flex flex-col lg:ml-10 lg:w-1/6">
                ...
                <div>
                    ...
                    <div class="py-6 flex flex-col justify-center items-center">
                        <a class="rounded-xl shadow-xl shadow-zinc-400 border-2 border-primary p-4" href="https://amzn.to/49cCt5R" target="blank"><img src="/images/wellplated2.jpg" alt="The Well Plated Cookbook"></a>
