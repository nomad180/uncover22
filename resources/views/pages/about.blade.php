...
<x-layout>
    <div class="px-4 md:px-8 lg:px-16 xl:px-16 border-b border-zinc-300 pt-20 md:pt-28 lg:pt-16 xl:pt-24 pb-8 md:pb-12 lg:pb-16 xl:pb-16 xl:pb-24 flex flex-col items-center bg-neutral-50">
        ...
        <div class="px-4 md:px-8 lg:px-16 xl:px-32 mb-4 pt-0 mt-0 mb-16">
            <div class="mt-2 transition duration-1000 hover:border hover:border-zinc-300 hover:bg-neutral-50 hover:shadow-lg hover:shadow-zinc-400 rounded-lg p-6">
                <div class="mx-auto pages">
                    <h2 class="text-5xl leading-tight 2xl:text-7xl text-center handwriting6">Meet our founder, Damon Leach</h2>
                    ...
                    <div class="flex flex-col md:flex-row justify-center mt-4">
                        <div class="md:w-1/2 md:pr-12">
                         ...
                         <div class="md:w-1/2 2xl:w-1/3">
                            <img class="rounded-xl shadow-xl shadow-zinc-400 border-2 border-primary mt-5" src="/images/damonnew2.jpg" alt="Damon Leach">
                        </div>
                    </div>
                </div>
    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-32">
        <h2 class="mt-16 xl:mt-24 2xl:mt-32 text-5xl leading-tight 2xl:text-7xl text-center handwriting6">Values</h2>
        <div class="flex flex-col md:flex-row flex-wrap md:mt-8">
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition duration-1000 hover:border hover:border-zind-300 hover:bg-neutral-50 hover:shadow-lg hover:shadow-zinc-400 rounded-lg pb-8 mb-10 p-4">
                    <h3 class="text-center font-semibold">Passion</h3>
                    <p>Passion is the heartbeat of our health coaching mission; it's the unwavering love for helping our clients unleash their full potential. It's the fire that drives us to explore, learn, and innovate, ensuring we deliver the most cutting-edge, effective strategies.</p>
                </div>
            </div>
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition duration-1000 hover:border hover:border-zinc-300 hover:bg-neutral-50 hover:shadow-lg hover:shadow-zinc-400 rounded-lg pb-8 mb-10 p-4">
                    <h3 class="text-center font-semibold">Teamwork</h3>
                    <p>Teamwork is the harmonious symphony of collaboration, where we blend expertise and perspectives to craft personalized, holistic health solutions. It's the realization that together, we are greater than the sum of our parts, creating a supportive ecosystem for our clients to flourish.</p>
                </div>
            </div>
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition duration-1000 hover:border hover:border-zinc-300 hover:bg-neutral-50 hover:shadow-lg hover:shadow-zinc-400 rounded-lg pb-8 mb-10 p-4">
                    <h3 class="text-center font-semibold">Commitment</h3>
                    <p>Commitment is our solemn oath, the pact we make with our clients to stand by their side, unwaveringly, on their journey to optimal health. It's the steadfast dedication to their goals, ensuring that every step we take together brings them closer to their best selves. </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-32 mb-4 pt-0 mt-0 mb-16">
        <div class="m-10 lg:mx-40 p-6 pages">
            ...
            <div class="flex justify-center w-full text-2xl mt-6">
                <a href="/" class="inline-flex items-center py-2 px-4 border-2 border-zinc-300 hover:bg-primary shadow-lg shadow-zinc-400 bg-secondary text-white no-underline rounded-full text-center">Explore Coaching</a>
            </div>
        </div>
    </div>
<x-explore/>
