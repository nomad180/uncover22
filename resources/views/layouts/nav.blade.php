<nav x-data="{ open: false }" class="lg:mb-12 xl:mb-14 2xl:mb-16">
    <div id="navbar" class="w-full px-4 md:px-6 flex -mt-6 lg:-mt-0 fixed z-50 top-0 border-b border-zinc-300 bg-white">
        ...
        <div class="hidden lg:flex justify-end m-auto">
            <a href="http://eepurl.com/iCMF4A" class="text-sm xl:text-xl px-4 py-2 border-2 border-zinc-300 hover:bg-primary shadow-lg shadow-zinc-400 no-underline bg-secondary text-white rounded-full text-center" target="blank">
                Member Portal
            </a>
        </div>
    </div>
