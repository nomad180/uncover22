<nav x-data="{ open: false }" class="bg-white border-b border-secondary/50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 lg:flex">
                    ...
                    <x-nav-link :href="route('uncoveryourfit')" :active="request()->routeIs('uncoveryourfit')">
                        {{ __('Uncover Your Fit') }}
                    </x-nav-link>
                    @endcan
                    @cannot('member')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="bg-gray-200 absolute top-50 left-0 z-10 w-full hidden lg:hidden">
