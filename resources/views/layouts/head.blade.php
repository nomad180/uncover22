...
<head lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Petit+Formal+Script&family=Rouge+Script&family=Style+Script&display=swap" rel="stylesheet">
