...
<x-layout>
    ...
    <div class="mb-8 px-4 md:px-8 lg:px-16 xl:px-32 lg:mt-0">
        ...
        <h2 class="mt-16 2xl:mt-16 text-5xl leading-tight 2xl:text-7xl text-center handwriting6 mb-4">Value of coaching</h2>
        ...
        <div class="flex flex-col md:flex-row justify-center flex-wrap mt-8">
            ...
            <div class="pages mb-10">
                <p><span class="font-semibold">If you don’t think our coaching is a good fit for you within the first 21 days, we’ll give you a full refund.</span> You get to decide if our coaching is worth it. Why do we do this? Because we stand by our work. We know you’ll walk out healthier and happier than ever before. All you have to do is take the first step.</p>
            </div>
        </div>
        <!--
