...
<x-layout>
    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-32 mb-4 pt-0 mt-0 mb-16">
        ...
        <h2 class="mt-16 xl:mt-24 2xl:mt-44 text-5xl 2xl:text-7xl text-center handwriting2">Features</h2>
        <div class="flex flex-col md:flex-row flex-wrap md:mt-8">
            <div class="flex md:w-1/2 mb-6 md:px-4 justify-center">
                <div class="transition duration-1000 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 rounded-lg pb-8 mb-10 p-4 w-full">
                    <ul>
                        ...
                        <li class="accordion">Accountability</li>
                            <div class="panel">
                        ...
                        <li class="accordion">Habit-Based</li>
                            <div class="panel">
            ...
            <div class="flex md:w-1/2 mb-6 md:px-4 justify-center">
                <div class="transition duration-1000 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 rounded-lg pb-8 mb-10 p-4 w-full">
                    <ul>
                        <li class="accordion mt-6">Physical Health</li>
                            <div class="panel">
                        ...
                        <li class="accordion">Mental Health</li>
                            <div class="panel">
        ...
        <!--Add features here-up to 10 in a bulleted list
         1. One-on-One Coaching (Not Group)
         2. Tailored Nutrition and Wellness Plan
         3. Accountability
         4. SMART Goals
         5. Habit based
         6. Phyiscal Health
         7. Mental Health
         8. 90-minute intro call
         9. 60-minute biweekly checkins
         10. Unlimited email questions
         11. Easy to follow lifestyle changes
        -->
