    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-32 pages">
        ...
        <div class="flex flex-col md:flex-row flex-wrap md:mt-8">
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/habits2.png" alt="" width="100%"></div>
            ...
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/support2.png" alt="" width="100%"></div>
            ...
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/goals2.png" alt="" width="100%"></div>
            ...
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/individual2.png" alt="" width="100%"></div>
            ...
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/busy5.png" alt="" width="100%"></div>
            ...
            <div class="flex md:w-1/3 mb-6 md:px-4">
                <div class="transition-colors duration-300 hover:border hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/50 sm:rounded-lg pb-8 mb-10 p-4">
                    <div class="flex justify-center"><img class="w-1/3 md:w-1/2" src="/images/personalized2.png" alt="" width="100%"></div>
