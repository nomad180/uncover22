    ...
    <div class="mb-8 mt-10 md:mt-20 lg:mt-32 xl:mt-44 px-4 md:px-8 lg:px-16 xl:px-32">
        <div class="mt-2 flex flex-col md:flex-row">
            <div class="w-full md:w-6/12 flex justify-center flex-col">
                ...
                <h2 class="text-lg xl:text-xl mt-4">Ditch fads, embrace sustainable wellness, and embark on a lifelong journey of fitness with our premier health coaching</h2>
